...
def train(model, dataset, name=None):
	...
	model.fit(x_ref, y_ref, n_epoch=500, validation_set=None,
	...
	'''if acc[0]*100 > 15:
		...
		i += 1
	'''
	#print('Average accuracy (20 runs) : ', (average/20)*100 )
...
if __name__ == '__main__':
	...
	# Raw path to dataset
	path = '/home/neurones/Documents/Developpement/Dataset/_1/'
	...
	if args.model == "elm":
		...
		elm = ELM(sess, batch_size, num_coeff, hidden_num, 7)
