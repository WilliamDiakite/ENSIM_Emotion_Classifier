...
def simple_preparation(dataset):
	...
	dum1, n_train_sample = x_ref.shape
	dum2, n_test_sample = x_test.shape
	...
	x_ref	= reshape(x_ref, (n_train_sample,13,7))
	x_test 	= x_test.transpose()
	x_test	= reshape(x_test, (n_test_sample,13,7))

	print('x_train shape : ', x_ref.shape)
	print('x_test shape : ', x_test.shape)
